...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{distinct\PYZus{}words}\PY{p}{(}\PY{n}{corpus}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{corpus} \PY{o}{=} \PY{p}{[}\PY{n}{x} \PY{k}{for} \PY{n}{y} \PY{o+ow}{in} \PY{n}{corpus} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{y}\PY{p}{]}
            \PY{n}{corpus\PYZus{}words} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{set}\PY{p}{(}\PY{n}{corpus}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{compute\PYZus{}co\PYZus{}occurrence\PYZus{}matrix}\PY{p}{(}\PY{n}{corpus}\PY{p}{,} \PY{n}{window\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{for} \PY{n}{index}\PY{p}{,} \PY{n}{word} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{words}\PY{p}{)}\PY{p}{:}
                \PY{n}{word2Ind}\PY{p}{[}\PY{n}{word}\PY{p}{]} \PY{o}{=} \PY{n}{index}
            \PY{k}{for} \PY{n}{file} \PY{o+ow}{in} \PY{n}{corpus}\PY{p}{:}
                \PY{k}{for} \PY{n}{index}\PY{p}{,} \PY{n}{word} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{file}\PY{p}{)}\PY{p}{:}
                    \PY{n}{row} \PY{o}{=} \PY{n}{word2Ind}\PY{p}{[}\PY{n}{word}\PY{p}{]}
                    \PY{n}{context} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                    \PY{k}{try}\PY{p}{:}
                        \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{file}\PY{p}{[}\PY{n}{index} \PY{o}{\PYZhy{}} \PY{n}{window\PYZus{}size}\PY{p}{]}
                        \PY{n}{left} \PY{o}{=} \PY{n}{index} \PY{o}{\PYZhy{}} \PY{n}{window\PYZus{}size}
                    \PY{k}{except} \PY{n+ne}{Exception}\PY{p}{:}
                        \PY{n}{left} \PY{o}{=} \PY{l+m+mi}{0}
                    \PY{n}{context} \PY{o}{+}\PY{o}{=} \PY{n}{file}\PY{p}{[}\PY{n}{left}\PY{p}{:} \PY{n}{index}\PY{p}{]}
                    \PY{k}{try}\PY{p}{:}
                        \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{file}\PY{p}{[}\PY{n}{index} \PY{o}{+} \PY{n}{window\PYZus{}size}\PY{p}{]}
                        \PY{n}{right} \PY{o}{=} \PY{n}{index} \PY{o}{+} \PY{n}{window\PYZus{}size} \PY{o}{+} \PY{l+m+mi}{1}
                    \PY{k}{except} \PY{n+ne}{Exception}\PY{p}{:}
                        \PY{n}{right} \PY{o}{=} \PY{k+kc}{None}
                    \PY{n}{context} \PY{o}{+}\PY{o}{=} \PY{n}{file}\PY{p}{[}\PY{n}{index} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{:} \PY{n}{right}\PY{p}{]}
                    \PY{k}{for} \PY{n}{context\PYZus{}word} \PY{o+ow}{in} \PY{n}{context}\PY{p}{:}
                        \PY{n}{M}\PY{p}{[}\PY{n}{row}\PY{p}{,} \PY{n}{word2Ind}\PY{p}{[}\PY{n}{context\PYZus{}word}\PY{p}{]}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
            \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{reduce\PYZus{}to\PYZus{}k\PYZus{}dim}\PY{p}{(}\PY{n}{M}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}    
            ...
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Running Truncated SVD over }\PY{l+s+si}{\PYZpc{}i}\PY{l+s+s2}{ words...}\PY{l+s+s2}{\PYZdq{}} \PY{o}{\PYZpc{}} \PY{p}{(}\PY{n}{M}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                ...
                \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
                \PY{c+c1}{\PYZsh{} Write your implementation here.}
            \PY{n}{truncated\PYZus{}svd} \PY{o}{=} \PY{n}{TruncatedSVD}\PY{p}{(}\PY{n}{n\PYZus{}components}\PY{o}{=}\PY{n}{k}\PY{p}{)}
            \PY{n}{M\PYZus{}reduced} \PY{o}{=} \PY{n}{truncated\PYZus{}svd}\PY{o}{.}\PY{n}{fit\PYZus{}transform}\PY{p}{(}\PY{n}{M}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{plot\PYZus{}embeddings}\PY{p}{(}\PY{n}{M\PYZus{}reduced}\PY{p}{,} \PY{n}{word2Ind}\PY{p}{,} \PY{n}{words}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{words}\PY{p}{:}
                 \PY{n}{indexes}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{word2Ind}\PY{p}{[}\PY{n}{word}\PY{p}{]}\PY{p}{)}
             \PY{n}{x\PYZus{}coords} \PY{o}{=} \PY{n}{M\PYZus{}reduced}\PY{p}{[}\PY{n}{indexes}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{y\PYZus{}coords} \PY{o}{=} \PY{n}{M\PYZus{}reduced}\PY{p}{[}\PY{n}{indexes}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
             \PY{k}{for} \PY{n}{i}\PY{p}{,}\PY{n}{word} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{words}\PY{p}{)}\PY{p}{:}
                 \PY{n}{x} \PY{o}{=} \PY{n}{x\PYZus{}coords}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 \PY{n}{y} \PY{o}{=} \PY{n}{y\PYZus{}coords}\PY{p}{[}\PY{n}{i}\PY{p}{]}
...
Outputted Plot:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{exploring_word_vectors_files/exploring_word_vectors_21_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{M\PYZus{}lengths}\PY{o}{.}\PY{n}{shape}\PY{p}{)}
...
(8185,)
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{exploring_word_vectors_files/exploring_word_vectors_24_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\textbf{Note}: This might take several minutes.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{def} \PY{n+nf}{load\PYZus{}word2vec}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
machines.}
    ...
    \hypertarget{reducing-dimensionality-of-word2vec-word-embeddings}{%
...
Done.
    ...
    \hypertarget{question-2.1-word2vec-plot-analysis-written-4-points}{%
...
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{worry}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} [('worried', 0.780526340007782),
...
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n}{w1} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{angry}\PY{l+s+s2}{\PYZdq{}}
         \PY{n}{w2} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{mad}\PY{l+s+s2}{\PYZdq{}}
...
works!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
        \PY{c+c1}{\PYZsh{} Write your analogy exploration code here.}
        \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Japan}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{USA}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-1-64b68923a729> in <module>()
          1 \# ------------------
          2 \# Write your analogy exploration code here.
    ----> 3 pprint.pprint(wv\_from\_bin.most\_similar(positive=["Japan", "Washington"], negative=["USA"]))
          4 
          5 
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{waiter}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{women}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{man}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
[('waiters', 0.5714064836502075),
 ...
 ('attentive\_waiters', 0.4379861056804657),
...
``woman'' and ``boss'' and most dissimilar to ``man'', and (b) which
terms are most similar to ``man'' and ``boss'' and most dissimilar to
``woman''. What do you find in the top 10?

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} Run this cell}
